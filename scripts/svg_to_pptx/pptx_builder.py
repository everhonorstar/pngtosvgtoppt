            ...
            try:
                ...
                if use_native_shapes:
                    ...
                    if (animation and animation != 'none'
                        ...
                        expanded_targets = _expand_anim_targets_to_group_children(
                            slide_xml, anim_targets,
                        )
                        seq_targets = [
                            (sid,
                            ...
                            for idx, (sid, _svg_id) in enumerate(expanded_targets)
                        ]
                        if animation == 'mixed':
                            mixed_animation_offset += max(0, len(expanded_targets) - 1)
                        timing_xml = '\n' + create_sequence_timing_xml(
